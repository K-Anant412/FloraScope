...
const test = () => {
  return (
    <div className='relative z-50 w-full h-screen border-2 border-black rounded-3xl md:p-4 p-2 flex-col gap-3 items-center hidden'>
            ...
            <div className='w-full md:h-[50%] h-fit flex md:flex-row flex-col items-center md:gap-6 gap-3'>
                ...
                <div className='md:h-full md:flex-1 h-70 w-full bg-[#E8F5E9] rounded-2xl flex flex-col items-center p-3 relative'>
                    ...
                    <h1 className='w-full h-fit md:p-4 p-2 text-3xl md:text-5xl text-[#2b532a] font-["Caveat_Brush"] flex items-center'>
                        {/* {plantDetails.primaryName?plantDetails.primaryName:"Too Long Name For Plant"} */}
                        Rose Gold
                    ...
                    <ul className='md:w-[50%] h-fit p-2 flex flex-col items-center relative -top-5 -left-55'>
                        ...
                        <li className='w-full text-2xl font-semibold font-["nunito"] h-fit p-1 flex items-center'>
                            ...
                            <p className='text-xl h-full flex items-center pt-1 ml-4 text-gray-500'>
                                {/* {plantDetails.scientificName?plantDetails.scientificName:"Too Long Name For Plant"} */}
                        ...
                        <li className='w-full text-2xl font-semibold font-["nunito"] h-fit p-1 flex items-center'>
                            ...
                            Full Name
                            <p className='text-xl h-full flex items-center pt-1 ml-4 text-gray-500'>
                                {plantDetails.fullName?plantDetails.fullName:"Too Long Name For Plant"}
                            </p>
                        </li>
                        ...
                        <li className='w-full text-2xl font-semibold font-["nunito"] h-fit p-1 flex items-center'>
                            ...
                            Family
                            <p className='text-xl h-full flex items-center pt-1 ml-4 text-gray-500'>
                                {plantDetails.family?plantDetails.family:"Too Long Name For Plant"}
                            </p>
                        </li>
                        ...
                        <li className='w-full text-2xl font-semibold font-["nunito"] h-fit p-1 flex items-center'>
                            ...
                            Other Names
                            <p className='text-xl h-full flex items-center pt-1 ml-4 text-gray-500 border-2'>
