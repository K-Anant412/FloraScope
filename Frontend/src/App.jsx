    ...
    <>
      <section className="relative w-screen h-screen overflow-hidden">
        ...
        <div className="relative z-30 w-full h-full overflow-hidden flex items-center justify-start md:pl-20 p-5">
          ...
          {/* Login card */}
          <div className="border rounded-2xl md:w-[40%] w-full md:h-[80%] h-[60%] relative md:top-0 border-gray-400 -top-28 shadow-[6px_8px_20px_rgba(0,0,0,0.22),-8px_-8px_20px_rgba(255,255,255,0.12)]">
            {/* Your login form */}
          </div>
