  ...
  return (
    <nav className='shrink-0 h-15 w-full md:p-6 p-3 md:border-r-2 border-b-2 flex items-center bg-white sticky'>
            ...
            <div className='hidden shrink-0 h-fit p-2 w-[72%] md:flex items-center justify-end gap-3'>
              <NavLink
                to='/login' 
                className='h-fit min-w-20 border flex items-center justify-center text-[19px] font-["nunito"] font-bold text-gray-700 mt-2 rounded-2xl transition-all duration-200 hover:bg-gray-200'
              >
                Log in
              </NavLink>
